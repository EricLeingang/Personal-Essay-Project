...
hist(as.vector(OPFocus),main = NULL, xlab = "Focus on Other People")
hist(as.vector(OverallFuture),main = NULL, xlab = "Overall Future")
hist(as.vector(ProAttRating),main = NULL, xlab = "Prosocial Attitudes")
hist(as.vector(WritingFuture),main = NULL, xlab = "Writing Future")
hist(as.vector(EnvFocus),main = NULL, xlab = "Environmental Focus")
